...
+ (FLTInitializeMessage *)fromList:(NSArray *)list;
+ (nullable FLTInitializeMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
+ (instancetype)makeWithMaxCacheSize:(NSNumber *)maxCacheSize
    maxCacheFileSize:(NSNumber *)maxCacheFileSize {
...
+ (FLTInitializeMessage *)fromList:(NSArray *)list {
  ...
  NSAssert(pigeonResult.maxCacheSize != nil, @"");
  pigeonResult.maxCacheFileSize = GetNullableObjectAtIndex(list, 1);
  NSAssert(pigeonResult.maxCacheFileSize != nil, @"");
  return pigeonResult;
}
+ (nullable FLTInitializeMessage *)nullableFromList:(NSArray *)list {
  return (list) ? [FLTInitializeMessage fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
    (self.maxCacheSize ?: [NSNull null]),
    (self.maxCacheFileSize ?: [NSNull null]),
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 129: 
      return [FLTInitializeMessage fromList:[self readValue]];
    case 130: 
...
- (void)writeValue:(id)value {
  ...
  } else if ([value isKindOfClass:[FLTInitializeMessage class]]) {
    [self writeByte:129];
    [self writeValue:[value toList]];
