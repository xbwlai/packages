...
class _TestHostVideoPlayerApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    } else if (value is InitializeMessage) {
      buffer.putUint8(129);
      writeValue(buffer, value.encode());
    } else {
    ...
    messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(__pigeon_channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.initialize was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final InitializeMessage? arg_msg = (args[0] as InitializeMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.initialize was null, expected non-null InitializeMessage.');
          try {
