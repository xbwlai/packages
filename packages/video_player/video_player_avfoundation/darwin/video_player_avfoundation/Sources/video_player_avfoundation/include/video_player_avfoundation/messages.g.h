...
@class FVPInitializeMessage;
@class FVPCreationOptions;

@interface FVPInitializeMessage : NSObject
...
@property(nonatomic, assign) NSInteger  maxCacheFileSize;
@end
...
- (void)initialize:(FVPInitializeMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
