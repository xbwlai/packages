...
@interface FVPInitializeMessage ()
+ (FVPInitializeMessage *)fromList:(NSArray *)list;
+ (nullable FVPInitializeMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
@implementation FVPInitializeMessage
+ (instancetype)makeWithMaxCacheSize:(NSInteger )maxCacheSize
    maxCacheFileSize:(NSInteger )maxCacheFileSize {
  FVPInitializeMessage* pigeonResult = [[FVPInitializeMessage alloc] init];
  pigeonResult.maxCacheSize = maxCacheSize;
  pigeonResult.maxCacheFileSize = maxCacheFileSize;
  return pigeonResult;
}
+ (FVPInitializeMessage *)fromList:(NSArray *)list {
  FVPInitializeMessage *pigeonResult = [[FVPInitializeMessage alloc] init];
  pigeonResult.maxCacheSize = [GetNullableObjectAtIndex(list, 0) integerValue];
  pigeonResult.maxCacheFileSize = [GetNullableObjectAtIndex(list, 1) integerValue];
  return pigeonResult;
}
+ (nullable FVPInitializeMessage *)nullableFromList:(NSArray *)list {
  return (list) ? [FVPInitializeMessage fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
    @(self.maxCacheSize),
    @(self.maxCacheFileSize),
  ];
}
@end
...
+ (instancetype)makeWithAsset:(nullable NSString *)asset
    ...
    useCache:(nullable NSNumber *)useCache
  ...
  pigeonResult.useCache = useCache;
  pigeonResult.cacheKey = cacheKey;
  return pigeonResult;
}
+ (FVPCreationOptions *)fromList:(NSArray *)list {
  FVPCreationOptions *pigeonResult = [[FVPCreationOptions alloc] init];
  ...
  pigeonResult.useCache = GetNullableObjectAtIndex(list, 5);
  pigeonResult.cacheKey = GetNullableObjectAtIndex(list, 6);
  return pigeonResult;
}
+ (nullable FVPCreationOptions *)nullableFromList:(NSArray *)list {
...
- (NSArray *)toList {
  return @[
    ...
    self.useCache ?: [NSNull null],
    self.cacheKey ?: [NSNull null],
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 129: 
      return [FVPInitializeMessage fromList:[self readValue]];
    default:
...
- (void)writeValue:(id)value {
  ...
  } else if ([value isKindOfClass:[FVPInitializeMessage class]]) {
    [self writeByte:129];
    [self writeValue:[value toList]];
  } else {
...
void SetUpFVPAVFoundationVideoPlayerApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FVPAVFoundationVideoPlayerApi> *api, NSString *messageChannelSuffix) {
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    ...
    if (api) {
      NSCAssert([api respondsToSelector:@selector(initialize:error:)], @"FVPAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(initialize:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FVPInitializeMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
